...
const PACKS: ReadonlyArray<{ map: string; base: string }> = [
  ...
  // Per-instrument split of the vendored Dirt-Samples/jazz/ kit, so it surfaces
  // as a drum-grid bank (`jazz_bd`, `jazz_sd`…) alongside the plain `jazz:N`
  // sample from Dirt-Samples.json. Kept out of Dirt-Samples.json itself since
  // that file is regenerated by scripts/vendor-samples.mjs.
  { map: 'jazz-bank.json', base: 'Dirt-Samples/' },
];
